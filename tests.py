...
class App:
    def __init__(self, window):
        ...
        self.video_source = 1  # URL de la cámara IP
        ...
        self.btn_capture = tk.Button(window, text="Capturar", width=10, command=self.capture, bg=self.initial_btn_color, fg='white', font=('Arial', 12), bd=0, relief=tk.RAISED, borderwidth=4, cursor="hand2")
        ...
        self.btn_exit = tk.Button(window, text="Exit", width=10, command=self.confirm_exit, bg='red', fg='white', font=('Arial', 12), bd=0, relief=tk.RAISED, borderwidth=4, cursor="hand2")
